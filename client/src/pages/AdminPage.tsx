    ...
    <div>
      ...
      {snippets.length === 0 ? (
        ...
        <div className="space-y-px">
          {snippets.map((s) => {
            const vis = visibilityStyle[s.visibility];
            return (
              <div
                key={s._id}
                className="flex items-center justify-between px-4 py-3.5 -mx-4 rounded-lg hover:bg-white/[0.03] transition-colors group"
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[11px] font-mono text-gray-500 shrink-0">{s.language}</span>
